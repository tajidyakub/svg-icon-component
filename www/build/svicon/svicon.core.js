  ...
  plt.isQueuedForUpdate.delete(elm), !plt.isDisconnectedMap.has(elm)) {
    ...
    // it off and generate a vnode for this
      ...
      try {
        ...
        // test if this component should be shadow dom
        // and if so does the browser supports it
        useNativeShadowDom && (rootElm = hostElm.shadowRoot), instance.render || instance.hostData || hostMeta || reflectHostAttr) {
...
})(window,document,{},"svicon","hydrated",[["sv-icon","sv-icon",0,[["el",64],["fillColor",1,1,"fill-color",2],["iconPath",1,1,"icon-path",2],["scale",1,1,1,2],["strokeColor",1,1,"stroke-color",2],["strokeWidth",1,1,"stroke-width",2]],1],["sv-icon-sprite","sv-icon-sprite",0,[["el",64],["fillColor",1,1,"fill-color",2],["icon",1,1,1,2],["scale",1,1,1,2],["strokeColor",1,1,"stroke-color",2],["strokeWidth",1,1,"stroke-width",2]]]]);